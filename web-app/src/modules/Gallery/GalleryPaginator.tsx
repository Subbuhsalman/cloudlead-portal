...
const GalleryPaginator = () => {
  ...
  useEffect(() => {
    getPaginatedGalleryList();
  }, [GalleryPerPage, GalleryFilter, GalleryPage]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    <div className="card m-0 p-1">
        <Paginator
          ...
          rows={GalleryPerPage}
          totalRecords={GalleryTotalRecords}
