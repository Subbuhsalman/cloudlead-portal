...
const PolicyPaginator = () => {
  ...
  useEffect(() => {
    getPaginatedPolicyList();
  }, [PolicyPerPage, PolicyFilter, PolicyPage]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    <div className="card m-0 p-1">
        <Paginator
          ...
          rows={PolicyPerPage}
          totalRecords={PolicyTotalRecords}
