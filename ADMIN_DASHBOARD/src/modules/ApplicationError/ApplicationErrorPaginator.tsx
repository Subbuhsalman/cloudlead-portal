...
const ApplicationErrorPaginator = () => {
  ...
  useEffect(() => {
    getPaginatedApplicationErrorList();
  }, [ApplicationErrorPerPage, ApplicationErrorFilter, ApplicationErrorPage]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    <div className="card m-0 p-1">
        <Paginator
          ...
          rows={ApplicationErrorPerPage}
          totalRecords={ApplicationErrorTotalRecords}
...
export { ApplicationErrorPaginator };
